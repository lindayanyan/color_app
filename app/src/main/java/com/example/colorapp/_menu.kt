 ...
 * Use the [_menu.newInstance] factory method to
 * create an instance of this fragment.
 */
class _menu : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.about_button).setOnClickListener {
            findNavController().navigate(R.id.action__menu_to_FirstFragment) //menu to about page
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment _menu.
         */
